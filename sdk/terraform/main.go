// euler-terraform-provider — the Terraform Provider for the platform
...
// pkg-go/eusdk) — 03§9.4 rule ⑤: one contract, many consumers. The provider
...
// but not built. The four core products (EUECS/EUOSS/EUVPC/EURDS) are covered
...
import (
	...
	"github.com/qifalab/euler-platform/sdk/terraform/internal/provider"
)
...
func main() {
	...
	err := providerserver.Serve(context.Background(), provider.New, providerserver.ServeOpts{
		Address: "registry.terraform.io/qifalab/euler",
		Debug:   debug,
	})
	if err != nil {
		log.Fatal(err.Error())
