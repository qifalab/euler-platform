# rc-storage — planned-component placeholder chart

This chart currently has **no corresponding code under `services/`**. It is
kept deliberately: the architecture docs list rc-storage as a planned component
...
service image exists; the `harbor.internal/cloudplatform/rc-storage` repository
