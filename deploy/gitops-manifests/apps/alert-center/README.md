# alert-engine — planned-component placeholder chart

This chart currently has **no corresponding code under `services/`**. It is
kept deliberately: the architecture docs list alert-engine as a planned component
...
service image exists; the `harbor.internal/cloudplatform/alert-engine` repository
